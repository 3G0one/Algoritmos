//Write a program that takes in two lists and returns the greatest number out of the two lists. Hint: call the function from Class. 
//Exercise #1(Exercise #1 should return a single number - the greatest number in the list).
//Write a program that takes in an array of numbers and returns the largest number in the list. Example: The given array is [3, 5, 7, 1, 6]
